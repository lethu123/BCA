  ...
  return (
    <div className='demo-inline-spacing'>
      <div className='basic-modal'>
        ...
        <Modal scrollable isOpen={basicModal} toggle={() => setBasicModal(!basicModal)}>
      ...
      <div className='vertically-centered-modal'>
        ...
        <Modal scrollable isOpen={centeredModal} toggle={() => setCenteredModal(!centeredModal)} className='modal-dialog-centered'>
  ...
  return (
    <div className='demo-inline-spacing'>
      <div>
        ...
        <Modal scrollable isOpen={formModal} toggle={() => setFormModal(!formModal)} className='modal-dialog-centered'>
      ...
      <div>
        ...
        <Modal scrollable isOpen={scrollModal} toggle={() => setScrollModal(!scrollModal)} className='modal-dialog-centered'>
      ...
      <div>
        ...
        <Modal scrollable scrollable isOpen={scrollInnerModal} toggle={() => setScrollInnerModal(!scrollInnerModal)}>
...
const ModalDestructuring = () => {
  ...
  return (
    <Fragment>
      ...
      <Modal scrollable isOpen={visibility} toggle={() => setVisibility(!visibility)} unmountOnClose={unmountOnClose}>
