  ...
  return (
    <React.Fragment>
      <Badge color='primary'>
        ...
        <span className='align-middle ml-1'>Primary</span>
      </Badge>
      <Badge color='secondary'>
        <Star size={12} className='align-middle' />
        <span className='align-middle ml-1'>Secondary</span>
      </Badge>
      <Badge color='success'>
        <Star size={12} className='align-middle' />
        <span className='align-middle ml-1'>Success</span>
      </Badge>
      <Badge color='danger'>
        <Star size={12} className='align-middle' />
        <span className='align-middle ml-1'>Danger</span>
      </Badge>
      <Badge color='warning'>
        <Star size={12} className='align-middle' />
        <span className='align-middle ml-1'>Warning</span>
      </Badge>
      <Badge color='info'>
        <Star size={12} className='align-middle' />
        <span className='align-middle ml-1'>Info</span>
      </Badge>
      <Badge color='dark'>
        <Star size={12} className='align-middle' />
        <span className='align-middle ml-1'>Dark</span>
      </Badge>
    </React.Fragment>
  )
}
