      ...
      <CardBody>
        ...
        <Row className="pt-50">
          <Col className="mb-2" md="6" sm="12">
            ...
            <Progress className="avg-session-progress mt-1" value="50" />
          </Col>
          <Col className="mb-2" md="6" sm="12">
            <p className="mb-50">Users: {kFormatter(data.users)}</p>
            <Progress
              className="avg-session-progress progress-bar-warning mt-1"
              value="60"
            />
          </Col>
          <Col md="6" sm="12">
            ...
            <Progress
              className="avg-session-progress progress-bar-danger mt-1"
              value="70"
            />
          </Col>
          <Col md="6" sm="12">
            ...
            <Progress
              className="avg-session-progress progress-bar-success mt-1"
              value="80"
            />
          </Col>
        </Row>
