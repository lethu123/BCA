      ...
      <CardBody className="invoice-padding pb-0">
        <div className="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
          <div>
            ...
            <p className="card-text mb-1">San Diego County, CA 91905, USA</p>
      ...
      <CardBody className="invoice-padding pt-0">
        <Row className="invoice-spacing">
          <Col className="p-0" lg="8">
            ...
            <h6 className="mb-1">{data.invoice.client.name}</h6>
            <CardText className="mb-1">{data.invoice.client.company}</CardText>
            <CardText className="mb-1">{data.invoice.client.address}</CardText>
            <CardText className="mb-1">{data.invoice.client.contact}</CardText>
              ...
              <Tag key={i} className="repeater-wrapper">
                <Row>
                  ...
                  >
                    ...
                    <div className="d-flex flex-column align-items-center justify-content-start border-left invoice-product-actions py-50 px-1">
                      <X
                        size={18}
