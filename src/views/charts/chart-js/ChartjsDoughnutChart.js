      ...
      <CardBody>
        ...
        <div className="d-flex justify-content-between mt-3 mb-1">
          <div className="d-flex align-items-center">
            ...
            <span className="font-weight-bold ml-75 mr-1">Desktop</span>
            <span>- 80%</span>
          </div>
          <div>
            <span>2%</span>
        ...
        <div className="d-flex justify-content-between mb-1">
          <div className="d-flex align-items-center">
            ...
            <span className="font-weight-bold ml-75 mr-1">Mobile</span>
            <span>- 10%</span>
          </div>
          <div>
            <span>8%</span>
        ...
        <div className="d-flex justify-content-between">
          <div className="d-flex align-items-center">
            ...
            <span className="font-weight-bold ml-75 mr-1">Tablet</span>
            <span>- 10%</span>
          </div>
          <div>
            <span>-5%</span>
