...
const dataType = [
  {id: 1, value: 'Đã nhận', color: 'primary'},
  {id: 2, value: 'Đã xem ', color: 'primary'},
  {id: 3, value: 'Đã trả lời ', color: 'primary'},
]

const FilterSocial = ({setSidebarFilter, sidebarFilter}) => {
  // ** Custom close btn
  const CloseBtn = (
    <X
      ...
      >
        ...
        <ModalBody>
          <PerfectScrollbar>
            ...
            <FilterColumn data={dataType} name="Tình trạng" />
          </PerfectScrollbar>
        </ModalBody>
