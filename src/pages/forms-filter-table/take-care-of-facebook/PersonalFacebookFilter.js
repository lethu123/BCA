...
const dataFriend = [
  {id: 1, value: 'Có', color: 'warning'},
  {id: 2, value: 'Không', color: 'warning'},
  {id: 3, value: 'Chờ', color: 'warning'},
]
...
const PersonalFacebookFilter = ({setSidebarFilter, sidebarFilter}) => {
  //useState
      ...
      >
        ...
        <ModalBody>
          <PerfectScrollbar>
            ...
            />
            <FilterColumn data={dataFriend} name="Bạn bè" />
...
export default PersonalFacebookFilter
