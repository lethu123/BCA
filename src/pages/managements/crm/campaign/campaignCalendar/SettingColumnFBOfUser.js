...
const data = [
  ...
  {id: 8, value: 'Ngày lấy dữ liệu', check: false},
  {id: 9, value: 'Ngày thực hiện', check: false},
  {id: 10, value: 'Nguồn dữ liệu', check: false},
  {id: 11, value: 'Khách hàng tiềm năng', check: false},
  {id: 12, value: 'Loại quan tâm', check: false},
]

const SettingColumnFBOfUser = ({sidebarOpen, setSidebarOpen}) => {
  // ** Custom close btn
  const CloseBtn = (
    <X
...
export default SettingColumnFBOfUser
