...
import logo from 'theme/assets/img/logo/logo-hspace.svg'
import {Mail, Phone, FileText, Download} from 'react-feather'

import 'theme/assets/scss/pages/invoice.scss'
import {useDispatch, useSelector} from 'react-redux'
import {enrollCourse} from 'theme/redux/actions/hschools/courseAction'

const InvoiceCheckout = ({carts}) => {
  const dispatch = useDispatch()
  const loading = useSelector(state => state.async.loading)
  const enroll = carts => dispatch(enrollCourse(carts))
  return (
    <React.Fragment>
      <Row>
