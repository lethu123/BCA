...
const ProgramCourseDetail = () => {
  const data = [
    ...
    {
      title: 'Bài 2:Tổng quan chương 1',
      content: (
        <CardText className="mb-0">
    ...
    {
      title: 'Bài 3: Bài học khởi nghiệp',
      content: (
        <CardText className="mb-0">
  ...
  return (
    <div>
      <h4 className="mt-5 mb-2">Chương 1</h4>
      <AppCollapse data={data} accordion />
      <h4 className="mt-5 mb-2">Chương 2</h4>
      <AppCollapse data={data} accordion />
    </div>
  )
}
