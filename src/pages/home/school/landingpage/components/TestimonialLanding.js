...
import TestiQoute from 'static/images/shapes/testi-qoute-1-1.png'

import TestiImageOne from 'static/images/resources/testi-1-1.jpg'
import TestiImageTwo from 'static/images/resources/testi-1-2.jpg'
import TestiImageThree from 'static/images/resources/testi-1-3.jpg'
                ...
                <Swiper {...paramsOne}>
                  <div className="swiper-slide">
                    <div className="testimonials-one__image">
                      <img src={TestiImageOne} alt="Awesome Testi 1" />
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="testimonials-one__image">
                      <img src={TestiImageTwo} alt="Awesome Testi 2" />
                    </div>
                  </div>
                  <div className="swiper-slide">
                    <div className="testimonials-one__image">
                      <img src={TestiImageThree} alt="Awesome testi 3" />
                    </div>
                  </div>
                </Swiper>
              </div>
          ...
          <Col xl={6} className="d-flex">
            <div className="my-auto">
              <BlockTitle
                ...
                titleText={`What Our Teacher Are Talking About`}
              />
