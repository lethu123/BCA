...
import {Button, Input, Col, Label, Row, CustomInput} from 'reactstrap'
    ...
    cell: row => {
      return (
        <div className="d-flex">
          <Trash className="text-danger" size={23} />
        </div>
      )
    },
  },
...
export default InviteForTeaching
