...
import EnvaluateTeacher from './EnvaluateTeacher.component'
import {ArrowLeftCircle} from 'react-feather'

const ViewAbstractStudentMain = () => {
    ...
    <Row>
      ...
      <Col lg="8">
        <Card>
          <CardBody>
            {active === 1 && <Overview />}
            {active === 2 && <ModulesCourse />}
            {active === 3 && <QandAClass />}
            {active === 4 && <AnnouncesClass />}
            {active === 5 && <QuizClass />}
            {active === 6 && <EnvaluateTeacher />}
          </CardBody>
        </Card>
      </Col>
    </Row>
...
export default ViewAbstractStudentMain
