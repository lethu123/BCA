        ...
        setDataSubmit(data => {
          ...
          if (!nodeB || (nodeB && !nodeB.source && !nodeB.target.length)) {
            let newData = {
              ...
              [oldEdge.target]: {
                ...data[oldEdge.target],
                source: oldEdge.target.includes('exit')
                  ? data[oldEdge.target].source
                    ? data[oldEdge.target].source.filter(
                        s => s !== oldEdge.source,
                      )
                    : null
                  : null,
              ...
              if (isExit) {
                ...
                newData = {
                  ...
                  [targetNode.id]: {
                    ...nodeB,
                    source: nodeB.source
                      ? !nodeB.source.includes(sourceNode.id)
                        ? [...nodeB.source, sourceNode.id]
                        : [...nodeB.source]
                      : [sourceNode.id],
                  },
                  [oldEdge.target]: {
