...
const dataFilterChart = [
  {id: 1, name: 'Tổng số LDP đăng kí'},
  {id: 2, name: 'Tổng số Data'},
  {id: 3, name: 'Số LDP mới đăng kí'},
  {id: 4, name: 'Số LDP đang hoạt động'},
  {id: 5, name: 'Số LDP tạm khóa'},
  {id: 6, name: 'Số Data AA'},
  {id: 7, name: 'Tỷ lệ chuyển đổi AA'},
  {id: 8, name: 'Số Data FA'},
  {id: 9, name: 'Tỷ lệ chuyển đổi FA'},
  {id: 10, name: 'Doanh thu'},
]
