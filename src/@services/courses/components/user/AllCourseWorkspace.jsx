  ...
  return (
    <div>
      ...
      <ReactPaginate
        ...
        // }`}
        containerClassName="pagination react-paginate separated-pagination pagination-md justify-content-center p-1 mt-1 mx-1"
      />
    </div>
  )
}

export default AllCourseWorkspace
