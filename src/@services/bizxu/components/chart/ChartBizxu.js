...
const dataColumn = {
  series: [
    {
      name: 'Số BizXu mua data',
      data: [76, 85, 101, 98, 87, 105, 91, 114, 94],
    },
    {
      name: 'Số dư BizXu trong ví',
...
const dataDonut = {
  options: {
    ...
    labels: ['Mua data', 'BizXu hoàn', 'Mua dịch vụ', 'Số dư'],
...
const dataFilterChart = [
  {id: 1, name: 'Tổng số giao dịch'},
  {id: 2, name: 'Số giao dịch thành công'},
  {id: 3, name: 'Tổng số BizXu'},
  {id: 4, name: 'Số dư BizXu trong ví'},
  {id: 5, name: 'Số BizXu mua data'},
  {id: 6, name: 'Số BizXu hoàn'},
  {id: 7, name: 'Số BizXu mua dịch vụ'},
  {id: 8, name: 'Doanh thu bảo hiểm'},
  {id: 9, name: 'Tỉ lệ chi phí'},
]
