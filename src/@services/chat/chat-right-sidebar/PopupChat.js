...
const PopupChat = ({openPopup, setOpenPopup}) => {
  ...
  return (
    <div
      className={`popup-chat popup-chat-responsive ${
        openPopup ? 'open-chat' : ''
      } `}
    >
      <Card className="chat-widget">
        <CardHeader>
          ...
          <div>
            <MoreVertical size={18} className="cursor-pointer mr-50" />
            <X
              size={18}
