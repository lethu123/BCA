...
// *** components
import ModalRequest from '../modal/ModalRequestMoney'
import FilterRequestMoney from '../filter/FilterRequestMoney'
import {columns} from '../column/RequestMoneyColumnTable'
  ...
  return (
    <div className="mt-10 ">
      <DataTableComponent
        ...
        FilterComponent={FilterRequestMoney}
        isExport
...
export default TableRequestMoney
