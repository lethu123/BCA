        ...
        <div className="card-body pb-0">
          <div className="d-flex align-items-center">
            ...
            <div style={{cursor: 'pointer'}} className="d-flex">
              <CopyToClipboard onCopy={onCopy} text={value} className="mr-1">
          ...
          <div>
            ...
            <div className="d-flex align-items-center ">
              <p className="btn btn-hover-text-primary btn-hover-icon-primary btn-sm btn-text-dark-50 bg-hover-light-primary rounded font-weight-bolder font-size-sm p-2 d-flex align-items-center">
                <span
                ...
                <span style={{fontSize: '15px'}}>{post.like}</span>
              </p>
            </div>
            {/*end::Action*/}
          </div>
