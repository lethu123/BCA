    ...
    data: [
      {
        ...
        by: 'Oliver Queen',
        size: '52kb',
        file: require('assets/images/icons/jpg.png').default,
      },
      {
        title: 'Parenting Guide',
        by: 'Alfred Pennyworth',
        size: '2.3mb',
        file: require('assets/images/icons/doc.png').default,
      },
      {
        title: 'Class Notes',
        by: 'Barry Allen',
      ...
      },
      {
        ...
        by: 'Walter White',
        size: '52mb',
        file: require('assets/images/icons/xls.png').default,
      },
    ],
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        img: require('assets/images/portrait/small/avatar-s-26.jpg').default,
        date: '14/03/2020',
      },
      {
        title: 'Robert Nash',
