...
const data = {
  pricing: {
    basicPlan: {
      title: 'Basic',
      img: require('assets/images/illustration/Pot1.svg').default,
    ...
    standardPlan: {
      title: 'Standard',
      img: require('assets/images/illustration/Pot2.svg').default,
    ...
    enterprisePlan: {
      title: 'Enterprise',
      img: require('assets/images/illustration/Pot3.svg').default,
