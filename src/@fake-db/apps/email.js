  ...
  emails: [
    {
      ...
      from: {
        ...
        name: 'Tommy Sicilia',
        avatar: require('assets/images/avatars/1.png').default,
      },
      to: [
        {
          name: 'me',
      ...
      attachments: [
        {
          fileName: 'log.txt',
          thumbnail: require('assets/images/icons/txt.png').default,
          url: '',
          size: '5mb',
        },
        {
          fileName: 'performance.xls',
          thumbnail: require('assets/images/icons/xls.png').default,
          url: '',
          size: '10mb',
        },
      ],
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Tressa Gass',
        avatar: require('assets/images/avatars/2.png').default,
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: require('assets/images/avatars/3.png').default,
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Louetta Esses',
        avatar: require('assets/images/avatars/4.png').default,
      },
      to: [
        {
          name: 'me',
      ...
      attachments: [
        {
          fileName: 'report.doc',
          thumbnail: require('assets/images/icons/doc.png').default,
          url: '',
          size: '32mb',
        },
      ],
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Rebecca Gilder',
        avatar: require('assets/images/avatars/6.png').default,
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: require('assets/images/avatars/9.png').default,
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: require('assets/images/avatars/7.png').default,
      },
      to: [
        {
          name: 'me',
      ...
      attachments: [
        {
          ...
          thumbnail: require('assets/images/icons/js.png').default,
          url: '',
          size: '29mb',
        },
      ],
    ...
    },
    {
      ...
      from: {
        ...
        avatar: require('assets/images/avatars/10.png').default,
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: require('assets/images/avatars/8.png').default,
      },
      to: [
        {
          name: 'me',
