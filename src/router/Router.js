...
import {DefaultRoute, Routes} from './page/'
...
const Router = () => {
  ...
  // Refresh token
  const expiration = useJwt.isValid()
  ...
  const NotAuthorized = lazy(() => import('pages/blank/NotAuthorized'))

  // *** Init Error Component
  const Error = lazy(() => import('pages/blank/Error'))
